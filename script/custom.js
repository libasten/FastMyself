...
zbp.plugin.on("comment.reply.start", "FastMyself", function(id) {
    var i = id
    $("#inpRevID").val(i)
...
zbp.plugin.on("comment.got", "FastMyself", function() {
    $("#cancel-reply").click()
})

zbp.plugin.on("comment.post.success", "FastMyself", function() {
    $("#cancel-reply").click()
})

zbp.plugin.on("comment.post.start", "FastMyself", function() {
